...
As outlined in the [performance assessment
guidebook](/assets/pdfs/perf_analysis_workbook_brief.pdf) SHAREing outlines a
performance analysis methodology that is broken down into:

1. Preparation
2. High-level analysis
3. Lower-level analysis

Further details of the preparation can be found in the guidebook, and the
