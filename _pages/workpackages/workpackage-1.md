...
title: "Workpackage 1: Performance Assessment"
classes: wide
layout: splash
---
<style>
...
<div class="workpackages-header" style= "font-size: 1.2rem">
  <h1>Work package 1: Performance Assessment</h1>
  <p></p>
</div>
...
<div class="wp-controls">
  ...
  {% if completed.size == 0 %}
    <div class="task-card" style="font-size: 0.75rem">No completed tasks.</div>
  {% endif %}
