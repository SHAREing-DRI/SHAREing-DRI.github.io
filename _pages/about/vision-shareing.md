---
permalink: /about/vision-shareing
...
<section class="section-wide">
  <h2>SHAREing’s Contributions to the Community</h2>
  ...
  <div class="institutions-grid">
    ...
    <div class="institution-card">
      ...
      <p>
        SHAREing will foster an ecosystem in which Research Technology Professionals
        and other stakeholders can design, prototype, and assess the most effective
        accelerated software–hardware combinations for their research.
      </p>
    </div>
    ...
    <div class="institution-card">
      ...
      <p>
        SHAREing will establish structured learning pathways that enable RTPs to
        acquire the full skill set required to deliver accelerated computing projects
        and train others.
      </p>
    </div>

    <div class="institution-card">
      <h3>Enabling Impact</h3>
      <p>
        SHAREing will showcase how RTP interventions enable significant research
        innovation when they evolve into dev-ops practices that lead accelerated
        computing projects.
      </p>
    </div>
...
<section class="section-wide">
  <div class="institutions-grid">
    ...
    <div class="institution-card">
      <h3>Assessment</h3>
      <p>
        SHAREing will establish a UK-wide service where research groups and SMEs can
        submit their code for assessment.
      </p>
      <ul>
        <li>Suitability for accelerated computing</li>
        <li>Expected performance gains</li>
        <li>Best-suited compute platforms</li>
      </ul>
...
<section class="section-wide">
  ...
  <p>
    SHAREing focuses predominantly on the required skills, learning ecosystems facilitating training, and the sharing of expertise, material and core initiatives, but also will contribute towards an ecosystem to apply the acquired skills to enable the use of accelerated compute within the UK’s research and innovation landscape.
  </p>

  <p>
    Inclusivity, accessibility and a science-centred ethos will be core to SHAREing, encouraging open-mindedness and critical thinking, respecting that there is often no single `right way’ when operating at the forefront of technology and research.
  </p>

  <p>
    It will deliver a talented workforce with core competencies for accelerated research computing environments. A close collaboration with national, European and international initiatives will strengthen its impact and branding and establish the UK as showcase of the benefits of using a holistic approach to creating a national DRI, where RTPs partner with academics to dev-op the most challenging simulation-, throughput- or AI-workloads.
  </p>
</section>
